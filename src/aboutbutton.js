export default function about() {
  ...
  sectionTitle.textContent = "Lorem Ipsum";
  ...
  sectionTitle2.textContent = "Loremus Ipsumus";

  const sectionPara2 = document.createElement("p");
  sectionPara2.textContent = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro asperiores quae temporibus aperiam facere sed consequuntur voluptatem optio dolorem? Officiis eum, minus rem tempore quibusdam consequuntur incidunt qui vitae laudantium.";
  ...
  section2.append(sectionTitle2, sectionPara2);

  mainContainer.append(section, section2);
